...
public class CourseController {
    ...
    public CourseEntity getAdmin(@RequestParam(value = "id") Long id) {
        return courseEntityMapper.selectByPrimaryKey(id);
    }

    @RequestMapping("/queryTeacherByCourseId")
    public Layui queryTeacherByCourseId(@RequestParam(value = "id") Long id) {
    ...
    public Integer updateLoginUser(@RequestBody LoginUserDTO loginUserDTO) {
        ...
        switch (userTypeEnum) {
            case ADMIN:
                AdminEntity adminEntity = adminEntityMapper.selectByPrimaryKey(loginUserDTO.getId());
                ...
                break;
            case TEACHER:
                TeacherEntity teacherEntity = teacherEntityMapper.selectByPrimaryKey(loginUserDTO.getId());
                ...
                break;
            case STUDENT:
                StudentEntity studentEntity = studentEntityMapper.selectByPrimaryKey(loginUserDTO.getId());
    ...
    public LoginUserDTO getLoginUser() {
        ...
        switch (userTypeEnum) {
            case ADMIN:
                AdminEntity adminEntity = adminEntityMapper.selectByPrimaryKey(Long.parseLong(loginUserId));
                userDTO.setId(adminEntity.getUserid());
                userDTO.setUsername(adminEntity.getUsername());
                userDTO.setPassword(adminEntity.getUserpw());
                break;
            case TEACHER:
                TeacherEntity teacherEntity = teacherEntityMapper.selectByPrimaryKey(Long.parseLong(loginUserId));
                ...
                break;
            case STUDENT:
                StudentEntity studentEntity = studentEntityMapper.selectByPrimaryKey(Long.parseLong(loginUserId));
